...
## 20260818000003 — Bonificação paga só após a quitação da NF-e

Regra do negócio: o bônus acompanha o dinheiro que entrou. A trava é no
trânsito para `pago` — lançar como pendente com a nota em aberto continua
valendo, e serve de fila do financeiro.

**Atenção:** lançamentos antigos sem `contrato_pedido_id` não poderão ser
marcados como pagos até serem vinculados a um pedido quitado.
