-- 1. CRITICAL: Remove the insecure policy that allows privilege escalation
DROP POLICY IF EXISTS "Users can add themselves as operador" ON public.empresa_membros;
