      ...
      {events.length === 0 ? (
        ...
        <div className="space-y-1 max-h-40 overflow-y-auto">
          {events.map((evt) => (
            <div
              key={evt.id}
              className="flex items-center gap-2 text-[11px] py-1 px-2 rounded hover:bg-muted/30"
            >
              ...
              {evt.hash_registro && (
                <span className="text-[9px] text-muted-foreground font-mono truncate max-w-[80px]" title={evt.hash_registro}>
