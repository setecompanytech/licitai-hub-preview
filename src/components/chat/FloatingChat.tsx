  ...
  useEffect(() => {
    if (open) {
      ...
      if (!hasGreeted && messages.length === 0) {
        setMessages([{
          role: 'assistant',
          content: 'Olá! 👋 Sou a **Lia**, sua assistente virtual do LicitIA. Como posso te ajudar hoje?\n\nPosso tirar dúvidas sobre:\n- 📋 Funcionalidades da plataforma\n- 📝 Licitações e editais\n- 💡 Como usar as ferramentas\n- 🆘 Suporte técnico'
        }]);
        setHasGreeted(true);
      }
    }
          ...
          >
            ...
            <div className={cn(
              ...
              <div className="flex items-center gap-2.5">
                ...
                <div>
                  <p className="text-sm font-semibold leading-none">Lia — Assistente LicitIA</p>
