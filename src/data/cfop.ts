/**
 * Tabela CFOP completa — Código Fiscal de Operações e Prestações.
 *
 * Transcrita da tabela oficial (PDF fornecido pelo dono do produto em 12/09).
 * Os cabeçalhos de grupo (1.100, 5.200…) NÃO são códigos operáveis e ficam
 * de fora: só entram os CFOPs de 4 dígitos que podem constar de nota fiscal.
 *
 * O formato compacto (código|descrição, um por linha) existe para a tabela
 * ser conferível contra o documento oficial linha a linha — e para a próxima
 * atualização ser um diff legível, não um mar de chaves.
 */
...
1125|Industrialização efetuada por outra empresa quando a mercadoria remetida não transitou pelo estabelecimento adquirente
1126|Compra para utilização na prestação de serviços sujeita ao ICMS
1128|Compra para utilização na prestação de serviços sujeita ao ISSQN
...
1203|Devolução de venda de produção do estabelecimento, destinada à ZFM ou Áreas de Livre Comércio
1204|Devolução de venda de mercadoria de terceiros, destinada à ZFM ou Áreas de Livre Comércio
...
1209|Devolução de mercadoria de terceiros, remetida em transferência
...
1254|Compra de energia elétrica por prestador de serviço de transporte
1255|Compra de energia elétrica por prestador de serviço de comunicação
1256|Compra de energia elétrica por produtor rural
...
1304|Aquisição de serviço de comunicação por prestador de serviço de transporte
1305|Aquisição de serviço de comunicação por geradora ou distribuidora de energia elétrica
1306|Aquisição de serviço de comunicação por produtor rural
...
1354|Aquisição de serviço de transporte por prestador de serviço de comunicação
1355|Aquisição de serviço de transporte por geradora ou distribuidora de energia elétrica
...
1401|Compra para industrialização ou produção rural de mercadoria sujeita a substituição tributária
1403|Compra para comercialização de mercadoria sujeita a substituição tributária
1406|Compra de bem para o ativo imobilizado sujeita a substituição tributária
1407|Compra de mercadoria para uso ou consumo sujeita a substituição tributária
1408|Transferência para industrialização ou produção rural de mercadoria sujeita a substituição tributária
1409|Transferência para comercialização de mercadoria sujeita a substituição tributária
1410|Devolução de venda de produção do estabelecimento com produto sujeito a substituição tributária
1411|Devolução de venda de mercadoria de terceiros sujeita a substituição tributária
1414|Retorno de produção do estabelecimento, remetida para venda fora, com produto sujeito a substituição tributária
1415|Retorno de mercadoria de terceiros, remetida para venda fora, sujeita a substituição tributária
...
1503|Devolução de produto remetido com fim específico de exportação, de produção do estabelecimento
1504|Devolução de mercadoria remetida com fim específico de exportação, de terceiros
1505|Devolução simbólica de mercadoria remetida para formação de lote de exportação, de produção própria
1506|Devolução simbólica de mercadoria de terceiros remetida para formação de lote de exportação
...
1903|Entrada de mercadoria remetida para industrialização e não aplicada no processo
1904|Retorno de remessa para venda fora do estabelecimento
1905|Entrada de mercadoria recebida para depósito fechado ou armazém geral
...
1919|Devolução simbólica de mercadoria vendida ou utilizada, remetida anteriormente em consignação
...
1924|Entrada para industrialização por conta e ordem do adquirente, sem transitar pelo adquirente
1925|Retorno de mercadoria remetida para industrialização por conta e ordem do adquirente
1926|Lançamento a título de reclassificação de mercadoria por formação de kit ou desagregação
1931|Lançamento pelo tomador do serviço de transporte com retenção atribuída ao remetente
1932|Aquisição de serviço de transporte iniciado em UF diversa da inscrição do prestador
...
2122|Compra para industrialização em que a mercadoria foi remetida ao industrializador sem transitar pelo adquirente
2124|Industrialização efetuada por outra empresa
2125|Industrialização efetuada por outra empresa quando a mercadoria não transitou pelo adquirente
...
2203|Devolução de venda de produção do estabelecimento, destinada à ZFM ou Áreas de Livre Comércio
2204|Devolução de venda de mercadoria de terceiros, destinada à ZFM ou Áreas de Livre Comércio
...
2209|Devolução de mercadoria de terceiros, remetida em transferência
...
2254|Compra de energia elétrica por prestador de serviço de transporte
2255|Compra de energia elétrica por prestador de serviço de comunicação
2256|Compra de energia elétrica por produtor rural
...
2304|Aquisição de serviço de comunicação por prestador de serviço de transporte
2305|Aquisição de serviço de comunicação por geradora ou distribuidora de energia elétrica
2306|Aquisição de serviço de comunicação por produtor rural
...
2354|Aquisição de serviço de transporte por prestador de serviço de comunicação
2355|Aquisição de serviço de transporte por geradora ou distribuidora de energia elétrica
2356|Aquisição de serviço de transporte por produtor rural
2401|Compra para industrialização ou produção rural de mercadoria sujeita a substituição tributária
2403|Compra para comercialização de mercadoria sujeita a substituição tributária
2406|Compra de bem para o ativo imobilizado sujeita a substituição tributária
2407|Compra de mercadoria para uso ou consumo sujeita a substituição tributária
2408|Transferência para industrialização ou produção rural de mercadoria sujeita a substituição tributária
2409|Transferência para comercialização de mercadoria sujeita a substituição tributária
2410|Devolução de venda de produção do estabelecimento com produto sujeito a substituição tributária
2411|Devolução de venda de mercadoria de terceiros sujeita a substituição tributária
2414|Retorno de produção do estabelecimento, remetida para venda fora, com produto sujeito a substituição tributária
2415|Retorno de mercadoria de terceiros, remetida para venda fora, sujeita a substituição tributária
2501|Entrada de mercadoria recebida com fim específico de exportação
2503|Devolução de produto remetido com fim específico de exportação, de produção do estabelecimento
2504|Devolução de mercadoria remetida com fim específico de exportação, de terceiros
2505|Devolução simbólica de mercadoria remetida para formação de lote de exportação, de produção própria
2506|Devolução simbólica de mercadoria de terceiros remetida para formação de lote de exportação
...
2903|Entrada de mercadoria remetida para industrialização e não aplicada no processo
2904|Retorno de remessa para venda fora do estabelecimento
2905|Entrada de mercadoria recebida para depósito fechado ou armazém geral
...
2919|Devolução simbólica de mercadoria vendida ou utilizada, remetida anteriormente em consignação
2920|Entrada de vasilhame ou sacaria
2921|Retorno de vasilhame ou sacaria
2922|Lançamento a título de simples faturamento decorrente de compra para recebimento futuro
2923|Entrada de mercadoria recebida do vendedor remetente, em venda à ordem
2924|Entrada para industrialização por conta e ordem do adquirente, sem transitar pelo adquirente
2925|Retorno de mercadoria remetida para industrialização por conta e ordem do adquirente
2931|Lançamento pelo tomador do serviço de transporte com retenção atribuída ao remetente
2932|Aquisição de serviço de transporte iniciado em UF diversa da inscrição do prestador
...
3354|Aquisição de serviço de transporte por prestador de serviço de comunicação
3355|Aquisição de serviço de transporte por geradora ou distribuidora de energia elétrica
3356|Aquisição de serviço de transporte por produtor rural
3503|Devolução de mercadoria exportada recebida com fim específico de exportação
...
3930|Entrada de bem sob regime especial aduaneiro de admissão temporária
...
5106|Venda de mercadoria de terceiros, que não deva por ele transitar
5109|Venda de produção do estabelecimento, destinada à ZFM ou Áreas de Livre Comércio
5110|Venda de mercadoria de terceiros, destinada à ZFM ou Áreas de Livre Comércio
5111|Venda de produção do estabelecimento remetida anteriormente em consignação industrial
5112|Venda de mercadoria de terceiros remetida anteriormente em consignação industrial
5113|Venda de produção do estabelecimento remetida anteriormente em consignação mercantil
5114|Venda de mercadoria de terceiros remetida anteriormente em consignação mercantil
...
5118|Venda de produção do estabelecimento entregue por conta e ordem do adquirente originário, em venda à ordem
5119|Venda de mercadoria de terceiros entregue por conta e ordem do adquirente originário, em venda à ordem
5120|Venda de mercadoria de terceiros entregue pelo vendedor remetente, em venda à ordem
5122|Venda de produção do estabelecimento remetida para industrialização, por conta e ordem do adquirente
5123|Venda de mercadoria de terceiros remetida para industrialização, por conta e ordem do adquirente
5124|Industrialização efetuada para outra empresa
5125|Industrialização efetuada para outra empresa quando a mercadoria não transitar pelo adquirente
...
5156|Transferência de mercadoria de terceiros, que não deva por ele transitar
...
5254|Venda de energia elétrica para prestador de serviço de transporte
5255|Venda de energia elétrica para prestador de serviço de comunicação
5256|Venda de energia elétrica para produtor rural
...
5304|Prestação de serviço de comunicação a prestador de serviço de transporte
5305|Prestação de serviço de comunicação a geradora ou distribuidora de energia elétrica
5306|Prestação de serviço de comunicação a produtor rural
...
5354|Prestação de serviço de transporte a prestador de serviço de comunicação
5355|Prestação de serviço de transporte a geradora ou distribuidora de energia elétrica
5356|Prestação de serviço de transporte a produtor rural
5357|Prestação de serviço de transporte a não contribuinte
5359|Prestação de serviço de transporte quando a mercadoria está dispensada de nota fiscal
5360|Prestação de serviço de transporte a contribuinte substituto
5401|Venda de produção do estabelecimento com produto sujeito a ST, como contribuinte substituto
5402|Venda de produção com produto sujeito a ST, entre contribuintes substitutos do mesmo produto
5403|Venda de mercadoria de terceiros sujeita a ST, como contribuinte substituto
5405|Venda de mercadoria de terceiros sujeita a ST, como contribuinte substituído
5408|Transferência de produção do estabelecimento com produto sujeito a substituição tributária
5409|Transferência de mercadoria de terceiros sujeita a substituição tributária
5410|Devolução de compra para industrialização ou produção rural sujeita a substituição tributária
5411|Devolução de compra para comercialização sujeita a substituição tributária
5412|Devolução de bem do ativo imobilizado sujeita a substituição tributária
5413|Devolução de mercadoria para uso ou consumo sujeita a substituição tributária
5414|Remessa de produção do estabelecimento para venda fora, com produto sujeito a substituição tributária
5415|Remessa de mercadoria de terceiros para venda fora, sujeita a substituição tributária
...
5502|Remessa de mercadoria de terceiros, com fim específico de exportação
5503|Devolução de mercadoria recebida com fim específico de exportação
5504|Remessa de mercadoria para formação de lote de exportação, de produção própria
5505|Remessa de mercadoria de terceiros para formação de lote de exportação
...
5555|Devolução de bem do ativo imobilizado de terceiro, recebido para uso
...
5602|Transferência de saldo credor de ICMS para compensação de saldo devedor
...
5651|Venda de combustível ou lubrificante de produção própria, para industrialização subsequente
5652|Venda de combustível ou lubrificante de produção própria, para comercialização
5653|Venda de combustível ou lubrificante de produção própria, para consumidor ou usuário final
5654|Venda de combustível ou lubrificante de terceiros, para industrialização subsequente
5655|Venda de combustível ou lubrificante de terceiros, para comercialização
5656|Venda de combustível ou lubrificante de terceiros, para consumidor ou usuário final
5657|Remessa de combustível ou lubrificante de terceiros para venda fora do estabelecimento
5658|Transferência de combustível ou lubrificante de produção do estabelecimento
5659|Transferência de combustível ou lubrificante de terceiros
...
5662|Devolução de compra de combustível ou lubrificante por consumidor ou usuário final
...
5903|Retorno de mercadoria recebida para industrialização e não aplicada no processo
...
5919|Devolução simbólica de mercadoria vendida ou utilizada, recebida anteriormente em consignação
...
5924|Remessa para industrialização por conta e ordem do adquirente, sem transitar pelo adquirente
5925|Retorno de mercadoria recebida para industrialização por conta e ordem do adquirente
5926|Lançamento a título de reclassificação de mercadoria por formação de kit ou desagregação
5927|Baixa de estoque decorrente de perda, roubo ou deterioração
5928|Baixa de estoque decorrente do encerramento da atividade da empresa
5929|Lançamento por emissão de documento fiscal também registrado em ECF
5931|Lançamento por retenção do imposto por ST atribuída ao remetente, em transporte autônomo
5932|Prestação de serviço de transporte iniciada em UF diversa da inscrição do prestador
...
6106|Venda de mercadoria de terceiros, que não deva por ele transitar
6107|Venda de produção do estabelecimento, destinada a não contribuinte
6108|Venda de mercadoria de terceiros, destinada a não contribuinte
6109|Venda de produção do estabelecimento, destinada à ZFM ou Áreas de Livre Comércio
6110|Venda de mercadoria de terceiros, destinada à ZFM ou Áreas de Livre Comércio
6111|Venda de produção do estabelecimento remetida anteriormente em consignação industrial
6112|Venda de mercadoria de terceiros remetida anteriormente em consignação industrial
6113|Venda de produção do estabelecimento remetida anteriormente em consignação mercantil
6114|Venda de mercadoria de terceiros remetida anteriormente em consignação mercantil
6115|Venda de mercadoria de terceiros, recebida anteriormente em consignação mercantil
...
6118|Venda de produção do estabelecimento entregue por conta e ordem do adquirente originário, em venda à ordem
6119|Venda de mercadoria de terceiros entregue por conta e ordem do adquirente originário, em venda à ordem
6120|Venda de mercadoria de terceiros entregue pelo vendedor remetente, em venda à ordem
6122|Venda de produção do estabelecimento remetida para industrialização, por conta e ordem do adquirente
6123|Venda de mercadoria de terceiros remetida para industrialização, por conta e ordem do adquirente
6124|Industrialização efetuada para outra empresa
6125|Industrialização efetuada para outra empresa quando a mercadoria não transitar pelo adquirente
...
6156|Transferência de mercadoria de terceiros, que não deva por ele transitar
...
6254|Venda de energia elétrica para prestador de serviço de transporte
6255|Venda de energia elétrica para prestador de serviço de comunicação
6256|Venda de energia elétrica para produtor rural
...
6304|Prestação de serviço de comunicação a prestador de serviço de transporte
6305|Prestação de serviço de comunicação a geradora ou distribuidora de energia elétrica
6306|Prestação de serviço de comunicação a produtor rural
...
6354|Prestação de serviço de transporte a prestador de serviço de comunicação
6355|Prestação de serviço de transporte a geradora ou distribuidora de energia elétrica
6356|Prestação de serviço de transporte a produtor rural
6357|Prestação de serviço de transporte a não contribuinte
6359|Prestação de serviço de transporte quando a mercadoria está dispensada de nota fiscal
6401|Venda de produção do estabelecimento com produto sujeito a ST, como contribuinte substituto
6402|Venda de produção com produto sujeito a ST, entre contribuintes substitutos do mesmo produto
6403|Venda de mercadoria de terceiros sujeita a ST, como contribuinte substituto
6404|Venda de mercadoria sujeita a ST cujo imposto já foi retido anteriormente
6408|Transferência de produção do estabelecimento com produto sujeito a substituição tributária
6409|Transferência de mercadoria de terceiros sujeita a substituição tributária
6410|Devolução de compra para industrialização ou produção rural sujeita a substituição tributária
6411|Devolução de compra para comercialização sujeita a substituição tributária
6412|Devolução de bem do ativo imobilizado sujeita a substituição tributária
6413|Devolução de mercadoria para uso ou consumo sujeita a substituição tributária
6414|Remessa de produção do estabelecimento para venda fora, com produto sujeito a substituição tributária
6415|Remessa de mercadoria de terceiros para venda fora, sujeita a substituição tributária
6501|Remessa de produção do estabelecimento, com fim específico de exportação
6502|Remessa de mercadoria de terceiros, com fim específico de exportação
6503|Devolução de mercadoria recebida com fim específico de exportação
6504|Remessa de mercadoria para formação de lote de exportação, de produção própria
6505|Remessa de mercadoria de terceiros para formação de lote de exportação
...
6555|Devolução de bem do ativo imobilizado de terceiro, recebido para uso
...
6651|Venda de combustível ou lubrificante de produção própria, para industrialização subsequente
6652|Venda de combustível ou lubrificante de produção própria, para comercialização
6653|Venda de combustível ou lubrificante de produção própria, para consumidor ou usuário final
6654|Venda de combustível ou lubrificante de terceiros, para industrialização subsequente
6655|Venda de combustível ou lubrificante de terceiros, para comercialização
6656|Venda de combustível ou lubrificante de terceiros, para consumidor ou usuário final
6657|Remessa de combustível ou lubrificante de terceiros para venda fora do estabelecimento
6658|Transferência de combustível ou lubrificante de produção do estabelecimento
6659|Transferência de combustível ou lubrificante de terceiros
6660|Devolução de compra de combustível ou lubrificante para industrialização subsequente
6661|Devolução de compra de combustível ou lubrificante para comercialização
6662|Devolução de compra de combustível ou lubrificante por consumidor ou usuário final
...
6903|Retorno de mercadoria recebida para industrialização e não aplicada no processo
...
6919|Devolução simbólica de mercadoria vendida ou utilizada, recebida anteriormente em consignação
6920|Remessa de vasilhame ou sacaria
6921|Devolução de vasilhame ou sacaria
6922|Lançamento a título de simples faturamento decorrente de venda para entrega futura
6923|Remessa de mercadoria por conta e ordem de terceiros, em venda à ordem
6924|Remessa para industrialização por conta e ordem do adquirente, sem transitar pelo adquirente
6925|Retorno de mercadoria recebida para industrialização por conta e ordem do adquirente
6929|Lançamento por emissão de documento fiscal também registrado em ECF
6931|Lançamento por retenção do imposto por ST atribuída ao remetente, em transporte autônomo
6932|Prestação de serviço de transporte iniciada em UF diversa da inscrição do prestador
...
7106|Venda de mercadoria de terceiros, que não deva por ele transitar
...
7930|Devolução de bem cuja entrada ocorreu sob regime especial aduaneiro de admissão temporária
7949|Outra saída de mercadoria ou prestação de serviço não especificado
`;

export type Cfop = { codigo: string; descricao: string };

export const CFOPS: Cfop[] = TABELA.trim().split('\n').map((linha) => {
  const [codigo, descricao] = linha.split('|');
  return { codigo: codigo.trim(), descricao: (descricao ?? '').trim() };
});

/** "5102" → "5.102" — a grafia da tabela oficial. */
export const formatarCfop = (codigo: string) =>
  codigo.length === 4 ? `${codigo[0]}.${codigo.slice(1)}` : codigo;

/**
 * Busca progressiva: cada dígito digitado afunila a lista. Pontos, espaços e
 * traços do que foi digitado são ignorados ("5.1", "5 1" e "51" são o mesmo
 * prefixo); texto sem dígito busca na DESCRIÇÃO (acento ignorado).
 */
export function buscarCfop(digitado: string, max = 12): Cfop[] {
  const bruto = String(digitado || '').trim();
  if (!bruto) return [];
  const digitos = bruto.replace(/\D/g, '');
  if (digitos.length > 0) {
    return CFOPS.filter((c) => c.codigo.startsWith(digitos)).slice(0, max);
  }
  const alvo = bruto.normalize('NFD').replace(/[\u0300-\u036f]/g, '').toLowerCase();
  return CFOPS.filter((c) =>
    c.descricao.normalize('NFD').replace(/[\u0300-\u036f]/g, '').toLowerCase().includes(alvo),
  ).slice(0, max);
}
