...
const municipiosPorUF: Record<string, string[]> = {
  ...
  PA: ['Belém', 'Ananindeua', 'Santarém', 'Marabá', 'Castanhal', 'Tucuruí', 'Parauapebas', 'Altamira', 'Abaetetuba', 'Cametá', 'Marituba', 'Bragança', 'Itaituba', 'Barcarena', 'Tailândia', 'Redenção', 'Paragominas', 'Salinópolis', 'Capanema', 'Breves'],
