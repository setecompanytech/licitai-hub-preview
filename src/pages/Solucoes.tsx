...
const modules = [
  ...
  { icon: Users, title: 'Gestão de Equipe', desc: 'Controle de colaboradores com tarefas, bonificações e relatório de atividades. Registro de ações por módulo para rastreabilidade operacional e governança interna.', href: '/equipe' },
