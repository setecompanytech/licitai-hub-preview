...
export function generateOrganogramaPDF() {
  ...
  doc.text('Todas as funcionalidades do sistema LicitIA', pageW / 2, y + 28, { align: 'center' });
  ...
  doc.setFontSize(9);
  doc.setFont('helvetica', 'bold');
  doc.text('LicitIA', pageW / 2, y + 6.5, { align: 'center' });
  y += boxH + 4;
  ...
  doc.save('LicitIA-Organograma-Completo.pdf');
}
