...
- [ ] Pôr o vigia no ar (com o OK do Ian): `index.js`, `session-manager.js` e o novo `vigia-sessao.js` na VPS, md5 igual ao template, 0 sessões; conferir no log a linha "👁️ Vigia da sessao do Compras.gov: confere os perfis a cada 20 min" e, na primeira conferência, `vigia_sessao` no `/health`
