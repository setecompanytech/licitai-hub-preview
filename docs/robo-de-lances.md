...
- [x] **A tela e o webhook** — escritos em 16/09:
  ...
  - **"Decremento percentual" vazio deixa de virar 1,5%** ao salvar — o `|| 1.5` gravava um passo que ninguém escolheu, e com a regra nova o vazio tem significado: vale o intervalo mínimo do edital. Uma disputa nova continua chegando com 1,5 escrito no campo, que a pessoa vê e pode apagar;
