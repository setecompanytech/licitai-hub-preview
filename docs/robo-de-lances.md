...
- [ ] Pôr no ar as correções do agendador: aplicar o SQL `20260916000004` e publicar o `robo-lances-webhook` (o webhook novo funciona antes do SQL — sem a coluna, segue sem nova tentativa)
